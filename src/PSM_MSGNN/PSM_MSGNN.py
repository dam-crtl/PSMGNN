...
from .PSM_MSConv import PSM_MSConv


class PSM_MSGNN_link_prediction(nn.Module):
    r"""The PSM_MSGNN model for link prediction.
    ...
    Args:
        ...
        layer (int, optional): Number of PSM_MSConv layers. Deafult: 2.
    ...
    def __init__(
        ...
        super(PSM_MSGNN_link_prediction, self).__init__()
...
class PSM_MSGNN_node_classification(nn.Module):
    r"""The PSM_MSGNN model for node classification.
    ...
    def __init__(
        ...
        super(PSM_MSGNN_node_classification, self).__init__()
